...
public class Vechicle_Report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vehiclefloating);

    }

    public void flt(View view) {

        AlertDialog.Builder builder = new AlertDialog.Builder(Vechicle_Report.this);

        LayoutInflater inflater = getLayoutInflater();
        View dialogView = inflater.inflate(R.layout.vehicle_report, null);
        ...
        btn_positive1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(Vechicle_Report.this,
        ...
        btn_positive5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Vechicle_Report.this, "Success", Toast.LENGTH_SHORT).show();
